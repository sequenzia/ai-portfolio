  ...
  experience: [
    {
      ...
      technologies: ['Python', 'TypeScript', 'React', 'Kubernetes', 'TensorFlow', 'PostgreSQL'],
  ...
  projects: [
    {
      ...
      technologies: ['React', 'Python', 'FastAPI', 'LangChain', 'PostgreSQL', 'Redis', 'Docker'],
      category: 'ai',
      links: {
    ...
    },
    {
      ...
      technologies: ['React', 'Go', 'Kubernetes', 'Prometheus', 'Grafana', 'PostgreSQL'],
      category: 'devops',
      links: {
    ...
    },
    {
      ...
      technologies: ['React Native', 'TypeScript', 'Node.js', 'MongoDB', 'ARKit', 'TensorFlow Lite'],
      category: 'mobile',
      links: {
  ...
  education: [
    {
      ...
      startDate: '2014',
      endDate: '2016',
      honors: ['Research Assistant in NLP Lab', 'Published 2 papers on neural language models'],
    ...
    },
    {
      ...
      endDate: '2014',
      gpa: '3.8',
      honors: ['Magna Cum Laude', 'Tau Beta Pi Engineering Honor Society', 'Dean\'s List'],
