...
export function BioCard({ data: _data }: BioCardProps) {
          ...
          <CardContent className="p-6">
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="flex-shrink-0">
                <div className="w-24 h-24 md:w-32 md:h-32 rounded-2xl bg-gradient-to-br from-primary-500 to-primary-700 flex items-center justify-center text-white text-3xl font-bold">
                  {bio.name
                    .split(' ')
                    .map((n) => n[0])
                    .join('')}
